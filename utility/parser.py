...
#     parser.add_argument('--data_path', nargs='?', default='/home/ww/Code/work5/MICRO2Ours/data/',
...
def parse_args():
    ...
    #train
    parser.add_argument('--data_path', nargs='?', default='/home/ww/Code/work5/MICRO2Ours/data/', help='Input data path.')
...
#     parser.add_argument('--regs', nargs='?', default='[1e-5,1e-5,1e-2]',
#                         help='Regularizations.')  #default: '[1e-5,1e-5,1e-2]'
#     parser.add_argument('--lr', type=float, default=0.00054,
#                         help='Learning rate.')
#     parser.add_argument('--D_lr', type=float, default=3e-4, help='Learning rate.')
...
#                         help='Lambda value of skip connection')
#     parser.add_argument('--cf_model', nargs='?', default='mmgcn',
#                         help='Downstream Collaborative Filtering model {mf, ngcf, lightgcn, vbpr, hafr}')   
#     parser.add_argument('--early_stopping_patience', type=int, default=7,
#                         help='') 
#     parser.add_argument('--layers', type=int, default=1,
#                         help='Number of item graph conv layers')  
